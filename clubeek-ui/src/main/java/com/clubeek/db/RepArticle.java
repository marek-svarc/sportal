...
public class RepArticle implements Repository<Article> {
	...
	public static void insert(Article.Location location, boolean priority, String caption, String summary, String content,
			Date creationDate, Date expirationDate, Owner owner, int clubTeamId, int categoryId) throws SQLException {
	 ...
	 * @throws SQLException
	 */
	public static void update(Article article) throws SQLException {
	 ...
	 * 
	 * @param id
	 *            identifikator modifikovane radky tbulky
	 * @param type
	 *            Umisteni clanku
	 * @param priority
	 *            Uroven priority clanku
	 * @param caption
	 *            Nadpis clanku
	 * @param content
	 *            Obsah clanku
	 * @param creationDate
	 *            Datum vytvoreni/posledn� zm�ny clanku
	 * @param expirationDate
	 *            Datum znepristupneni clanku
	 * @throws SQLException
	 */
	 ...
	 * @throws SQLException
	 */
	public static List<Article> selectAll(TableColumn[] columns) throws SQLException {
		columns = getColumns(columns);
	 ...
	 * 
	 * @param id
	 *            index radku v tabulce "category"
	 * @param columns
	 ...
	 * @throws SQLException
	 */
	public static Article selectById(int id, TableColumn[] columns) throws SQLException {
		columns = getColumns(columns);
	...
	@Override
	public void insertRow(Article value) throws SQLException {
		RepArticle.insert(value);
	}

	@Override
	public void updateRow(Article value) throws SQLException {
	...
	@Override
	public void readValue(ResultSet result, int resultsColumnId, Article data, Object dataColumnId) throws SQLException {
