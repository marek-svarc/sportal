...
- clubeek-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- clubeek-ui: main application module, development time
- clubeek-production: module that produces a production mode WAR for deployment
